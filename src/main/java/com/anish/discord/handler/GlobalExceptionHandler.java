package com.anish.discord.handler;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Object> handleValidationError(MethodArgumentNotValidException e) {
        ...
        ApiResponseDto response = new ApiResponseDto(HttpStatus.BAD_REQUEST.value(),
    ...
    public ResponseEntity<Object> handleServerError(Exception e) {
        ...
        ApiResponseDto response = new ApiResponseDto(HttpStatus.INTERNAL_SERVER_ERROR.value(),
